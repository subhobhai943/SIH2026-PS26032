...
| `/profile` | [`src/app/profile/page.tsx`](file:///home/ubuntu/SIH2026-PS26032/client/src/app/profile/page.tsx) | **Farmer Profile & Government Dossier:** Comprehensive self-service profile page: (1) Biometric front-camera portrait capture with client compression, (2) UIDAI Aadhaar & PFMS DBT linkage verification status, (3) Interactive crop portfolio & land area editor, (4) Direct links to slot booking, gate passes, and SMS notification dispatch logs. |
